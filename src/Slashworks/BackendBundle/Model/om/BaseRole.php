...
abstract class BaseRole extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Slashworks\\BackendBundle\\Model\\RolePeer';
    ...
    public function setRole($v)
    {
        ...
        if ($this->role !== $v) {
            $this->role = $v;
            $this->modifiedColumns[] = RolePeer::ROLE;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RolePeer::ROLE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RolePeer::ROLE)) $criteria->add(RolePeer::ROLE, $this->role);
