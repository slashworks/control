...
abstract class BaseSystemSettings extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Slashworks\\BackendBundle\\Model\\SystemSettingsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SystemSettingsPeer
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = SystemSettingsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SystemSettings object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SystemSettingsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SystemSettingsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SystemSettingsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    {
        $pos = SystemSettingsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        $criteria = new Criteria(SystemSettingsPeer::DATABASE_NAME);
        $criteria->add(SystemSettingsPeer::ID, $this->id);
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SystemSettings Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SystemSettingsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SystemSettingsPeer();
        }
    ...
    {
        return (string) $this->exportTo(SystemSettingsPeer::DEFAULT_STRING_FORMAT);
    }
