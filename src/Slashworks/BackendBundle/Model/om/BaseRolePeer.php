...
use Slashworks\BackendBundle\Model\map\RoleTableMap;
...
abstract class BaseRolePeer
{
    ...
    const OM_CLASS = 'Slashworks\\BackendBundle\\Model\\Role';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Slashworks\\BackendBundle\\Model\\map\\RoleTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (RolePeer::ID, RolePeer::NAME, RolePeer::ROLE, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (RolePeer::ID => 0, RolePeer::NAME => 1, RolePeer::ROLE => 2, ),
