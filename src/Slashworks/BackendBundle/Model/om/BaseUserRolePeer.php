...
use Slashworks\BackendBundle\Model\map\UserRoleTableMap;
...
abstract class BaseUserRolePeer
{
    ...
    const OM_CLASS = 'Slashworks\\BackendBundle\\Model\\UserRole';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Slashworks\\BackendBundle\\Model\\map\\UserRoleTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUserRolePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Slashworks\BackendBundle\Model\map\UserRoleTableMap());
      }
    }
