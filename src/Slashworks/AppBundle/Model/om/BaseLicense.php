...
abstract class BaseLicense extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Slashworks\\AppBundle\\Model\\LicensePeer';
    ...
    /**
     * The value for the max_clients field.
     * @var        int
     */
    ...
    /**
     * Get the [max_clients] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [valid_until] column value.
     *
     * @return string
     */
    ...
    public function setDomain($v)
    {
        ...
        if ($this->domain !== $v) {
            $this->domain = $v;
            $this->modifiedColumns[] = LicensePeer::DOMAIN;
        }
