...
abstract class BaseRemoteHistoryContao extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Slashworks\\AppBundle\\Model\\RemoteHistoryContaoPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RemoteHistoryContaoPeer
     */
    ...
    /**
     * The value for the apiversion field.
     * @var        string
     */
    ...
    /**
     * The value for the config_displayerrors field.
     * Note: this column has a database default value of: 'Off'
     * @var        string
     */
    protected $config_displayerrors;

    /**
     * The value for the config_bypasscache field.
     * Note: this column has a database default value of: 'Off'
     * @var        string
     */
    protected $config_bypasscache;

    /**
     * The value for the config_minifymarkup field.
     * Note: this column has a database default value of: 'Off'
     * @var        string
     */
    protected $config_minifymarkup;

    /**
     * The value for the config_debugmode field.
     * Note: this column has a database default value of: 'Off'
     * @var        string
     */
    protected $config_debugmode;

    /**
     * The value for the config_maintenancemode field.
     * Note: this column has a database default value of: 'Off'
     * @var        string
     */
    protected $config_maintenancemode;

    /**
     * The value for the config_gzipscripts field.
     * Note: this column has a database default value of: 'Off'
     * @var        string
     */
    protected $config_gzipscripts;

    /**
     * The value for the config_rewriteurl field.
     * Note: this column has a database default value of: 'Off'
     * @var        string
     */
    protected $config_rewriteurl;

    /**
     * The value for the config_adminemail field.
     * @var        string
     */
    protected $config_adminemail;

    /**
     * The value for the config_cachemode field.
     * @var        string
     */
    protected $config_cachemode;
    ...
    /**
     * The unserialized $extensions value - i.e. the persisted object.
     * This is necessary to avoid repeated calls to unserialize() at runtime.
     * @var        object
     */
    protected $extensions_unserialized;
    ...
    /**
     * The unserialized $log value - i.e. the persisted object.
     * This is necessary to avoid repeated calls to unserialize() at runtime.
     * @var        object
     */
    protected $log_unserialized;

    /**
     * The value for the php field.
     * @var
     */
    protected $php;

    /**
     * The unserialized $php value - i.e. the persisted object.
     * This is necessary to avoid repeated calls to unserialize() at runtime.
     * @var        object
     */
    protected $php_unserialized;

    /**
     * The value for the mysql field.
     * @var
     */
    protected $mysql;

    /**
     * The unserialized $mysql value - i.e. the persisted object.
     * This is necessary to avoid repeated calls to unserialize() at runtime.
     * @var        object
     */
    protected $mysql_unserialized;
    ...
    /**
     * Initializes internal state of BaseRemoteHistoryContao object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [apiversion] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [config_displayerrors] column value.
     *
     * @return string
     */
    public function getConfigDisplayerrors()
    {

        return $this->config_displayerrors;
    }

    /**
     * Get the [config_bypasscache] column value.
     *
     * @return string
     */
    public function getConfigBypasscache()
    {

        return $this->config_bypasscache;
    }

    /**
     * Get the [config_minifymarkup] column value.
     *
     * @return string
     */
    public function getConfigMinifymarkup()
    {

        return $this->config_minifymarkup;
    }

    /**
     * Get the [config_debugmode] column value.
     *
     * @return string
     */
    public function getConfigDebugmode()
    {

        return $this->config_debugmode;
    }

    /**
     * Get the [config_maintenancemode] column value.
     *
     * @return string
     */
    public function getConfigMaintenancemode()
    {

        return $this->config_maintenancemode;
    }

    /**
     * Get the [config_gzipscripts] column value.
     *
     * @return string
     */
    public function getConfigGzipscripts()
    {

        return $this->config_gzipscripts;
    }

    /**
     * Get the [config_rewriteurl] column value.
     *
     * @return string
     */
    public function getConfigRewriteurl()
    {

        return $this->config_rewriteurl;
    }

    /**
     * Get the [config_adminemail] column value.
     *
     * @return string
     */
    public function getConfigAdminemail()
    {
        ...
        return $this->config_adminemail;
    }

    /**
     * Get the [config_cachemode] column value.
     *
     * @return string
     */
    public function getConfigCachemode()
    {

        return $this->config_cachemode;
    }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RemoteHistoryContaoPeer::NAME;
        }
     ...
     * @return RemoteHistoryContao The current object (for fluent API support)
     */
    public function setConfigDisplayerrors($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
     ...
     * @return RemoteHistoryContao The current object (for fluent API support)
     */
    public function setConfigBypasscache($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
     ...
     * @return RemoteHistoryContao The current object (for fluent API support)
     */
    public function setConfigMinifymarkup($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
     ...
     * @return RemoteHistoryContao The current object (for fluent API support)
     */
    public function setConfigDebugmode($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
     ...
     * @return RemoteHistoryContao The current object (for fluent API support)
     */
    public function setConfigMaintenancemode($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
     ...
     * @return RemoteHistoryContao The current object (for fluent API support)
     */
    public function setConfigGzipscripts($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
     ...
     * @return RemoteHistoryContao The current object (for fluent API support)
     */
    public function setConfigRewriteurl($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
     ...
     * @return RemoteHistoryContao The current object (for fluent API support)
     */
    public function setConfigAdminemail($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
     ...
     * @return RemoteHistoryContao The current object (for fluent API support)
     */
    public function setConfigCachemode($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RemoteHistoryContaoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RemoteHistoryContaoQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RemoteHistoryContaoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RemoteHistoryContaoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RemoteHistoryContaoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        $criteria = new Criteria(RemoteHistoryContaoPeer::DATABASE_NAME);
        $criteria->add(RemoteHistoryContaoPeer::ID, $this->id);
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RemoteHistoryContao Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RemoteHistoryContaoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RemoteHistoryContaoPeer();
        }
    ...
    {
        return (string) $this->exportTo(RemoteHistoryContaoPeer::DEFAULT_STRING_FORMAT);
    }
