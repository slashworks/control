...
abstract class BaseUserCustomerRelation extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Slashworks\\AppBundle\\Model\\UserCustomerRelationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        UserCustomerRelationPeer
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = UserCustomerRelationPeer::USER_ID;
        }
    ...
    public function setCustomerId($v)
    {
        ...
        if ($this->customer_id !== $v) {
            $this->customer_id = $v;
            $this->modifiedColumns[] = UserCustomerRelationPeer::CUSTOMER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = UserCustomerRelationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating UserCustomerRelation object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UserCustomerRelationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserCustomerRelationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserCustomerRelationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    {
        $criteria = new Criteria(UserCustomerRelationPeer::DATABASE_NAME);
        $criteria->add(UserCustomerRelationPeer::ID, $this->id);
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UserCustomerRelation Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UserCustomerRelationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UserCustomerRelationPeer();
        }
    ...
    {
        return (string) $this->exportTo(UserCustomerRelationPeer::DEFAULT_STRING_FORMAT);
    }
