...
use Slashworks\AppBundle\Model\map\ApiLogTableMap;
...
abstract class BaseApiLogPeer
{
    ...
    const OM_CLASS = 'Slashworks\\AppBundle\\Model\\ApiLog';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Slashworks\\AppBundle\\Model\\map\\ApiLogTableMap';
    ...
    /** the column name for the dt_call field */
    const DT_CALL = 'api_log.dt_call';

    /** the column name for the remote_app_id field */
    const REMOTE_APP_ID = 'api_log.remote_app_id';

    /** the column name for the statuscode field */
    const STATUSCODE = 'api_log.statuscode';

    /** the column name for the last_response field */
    const LAST_RESPONSE = 'api_log.last_response';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'DtCall', 'RemoteAppId', 'Statuscode', 'LastResponse', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'dtCall', 'remoteAppId', 'statuscode', 'lastResponse', ),
        BasePeer::TYPE_COLNAME => array (ApiLogPeer::ID, ApiLogPeer::DT_CALL, ApiLogPeer::REMOTE_APP_ID, ApiLogPeer::STATUSCODE, ApiLogPeer::LAST_RESPONSE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DT_CALL', 'REMOTE_APP_ID', 'STATUSCODE', 'LAST_RESPONSE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'dt_call', 'remote_app_id', 'statuscode', 'last_response', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'DtCall' => 1, 'RemoteAppId' => 2, 'Statuscode' => 3, 'LastResponse' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'dtCall' => 1, 'remoteAppId' => 2, 'statuscode' => 3, 'lastResponse' => 4, ),
        BasePeer::TYPE_COLNAME => array (ApiLogPeer::ID => 0, ApiLogPeer::DT_CALL => 1, ApiLogPeer::REMOTE_APP_ID => 2, ApiLogPeer::STATUSCODE => 3, ApiLogPeer::LAST_RESPONSE => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DT_CALL' => 1, 'REMOTE_APP_ID' => 2, 'STATUSCODE' => 3, 'LAST_RESPONSE' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'dt_call' => 1, 'remote_app_id' => 2, 'statuscode' => 3, 'last_response' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function doCountJoinRemoteApp(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ApiLogPeer::REMOTE_APP_ID, RemoteAppPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of ApiLog objects pre-filled with their RemoteApp objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinRemoteApp(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (ApiLog) to $obj2 (RemoteApp)
                $obj2->addApiLog($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (ApiLog) to the collection in $obj2 (RemoteApp)
                $obj2->addApiLog($obj1);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ApiLogPeer::ID) && $criteria->keyContainsValue(ApiLogPeer::ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ApiLogPeer::ID);
            $value = $criteria->remove(ApiLogPeer::ID);
            if ($value) {
                $selectCriteria->add(ApiLogPeer::ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ApiLogPeer::ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ApiLogPeer::DATABASE_NAME);
            $criteria->add(ApiLogPeer::ID, $pks, Criteria::IN);
